...
public class ConsumerTest {
        ...
        public RequestResponsePact createPact(PactDslWithProvider builder) {
            ...
            DslPart reqAndResponseBody = new PactDslJsonBody()
                    ...
                    .stringType("lastName","Bijili")
                    .stringType("email", "divyabijili@gmail.com");
        ...
        public void postRequestTest(){
            ...
            reqBody.put("lastName","Bijili");
            reqBody.put("email", "divyabijili@gmail.com");
            given().baseUri("http://localhost:8282").headers(headers).body(reqBody).log().all().when().post("/api/users").then().statusCode(201).body("firstName", equalTo("Divya")).log().all();
