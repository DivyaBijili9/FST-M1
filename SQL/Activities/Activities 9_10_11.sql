REM   Script: Activities 9-11
REM   Activities 9,10,11
...
SELECT a.customer_name, a.city, a.grade, b.salesman_name AS "Salesman", b.city FROM customers a LEFT OUTER JOIN salesman b ON a.salesman_id=b.salesman_id WHERE a.grade<300  
...
SELECT a.customer_name, a.city, a.grade, b.salesman_name AS "Salesman", b.salesman_city AS "City" FROM customers a LEFT OUTER JOIN salesman b ON a.salesman_id=b.salesman_id WHERE a.grade<300  
ORDER BY a.customer_id;
